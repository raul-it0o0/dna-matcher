...
int main(int argc, char* argv[]) {
    ...
    std::cout << "The child DNA contains " << matches << " patterns found in the parent DNA" << std::endl;
    std::cout << "Which is a " << std::setprecision(2) << ((float)matches / numPatterns) * 100 << "% match." << std::endl;
